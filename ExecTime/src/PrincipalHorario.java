...
public class PrincipalHorario {
	...
	public static void main(String[] args) {
		...
		System.out.println("Hora 1 em Universal: " + HU1 + " e em Padrão: "+ HP1);
		System.out.println("Hora 2 em Universal: " + HU2 + " e em Padrão: "+ HP2);
		System.out.println("Hora 3 em Universal: " + HU3 + " e em Padrão: "+ HP3);
		System.out.println("Hora 4 em Universal: " + HU4 + " e em Padrão: "+ HP4);
		System.out.println(" ");
